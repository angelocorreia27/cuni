<div class="row">
	...
	<div class="col-lg-3 col-md-4 col-sm-6">
        <div class="form-group form-group-sm">
			...
			{!! Form::select('id_maternidade',['' => 'Escolha a reprodutora'] + $engorda,$engorda->id_maternidade, ['class'=>'form-control select2','style'=>'width: 100%;'])  !!}
		</div>
	</div>
	...
	<div class="col-lg-3 col-md-4 col-sm-6">
        <div class="form-group form-group-sm">
			...
			{!! Form::select('id_gaiola',['' => 'Escolha o Gaiola'] + $engorda,$engorda->id_gaiola, ['class'=>'form-control select2','style'=>'width: 100%;'])  !!}
		</div>
	</div>
